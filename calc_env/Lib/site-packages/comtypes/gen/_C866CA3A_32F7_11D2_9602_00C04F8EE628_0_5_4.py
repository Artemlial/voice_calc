...
__all__ = [
    'DISPID_SpeechGrammarRule', 'eLEXTYPE_RESERVED10',
    'SpObjectToken', 'SPSHORTCUTPAIRLIST', 'DISPID_SADefaultFormat',
    'DISPID_SVWaitUntilDone', 'ISpObjectToken', 'SSFMCreate',
    'SpeechWordPronounceable', 'SAFT44kHz8BitStereo',
    'DISPID_SLPPartOfSpeech', 'SPEI_END_SR_STREAM',
    'SpeechTokenKeyFiles', 'DISPID_SRGRules',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SpeechXMLRecoResult',
    'SPPS_Unknown', 'SPSSuppressWord', 'SWTAdded',
    'SAFT44kHz16BitMono', 'SREPhraseStart', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRGetRecognizers', 'DISPID_SRCState',
    'SAFTNoAssignedFormat', 'DISPID_SPIEnginePrivateData',
    'DISPID_SGRName', 'DISPID_SGRsFindRule', 'SPSNoun', 'SVP_20',
    'DISPID_SPRuleConfidence', 'SDKLCurrentUser', 'SDKLCurrentConfig',
    'SWTDeleted', 'DISPID_SLGetGenerationChange',
    'DISPID_SVSPhonemeId', 'SpeechVoicePriority', 'SBONone',
    'eLEXTYPE_PRIVATE17', 'SVSFParseMask',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpShortcut', 'SRERecoOtherContext',
    'DISPID_SLAddPronunciationByPhoneIds', 'SP_VISEME_0',
    'DISPID_SOTCDefault', 'DISPID_SRCEAdaptation',
    'SAFT32kHz16BitMono', 'SRAORetainAudio', 'SPVISEMES',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPSEMANTICERRORINFO', 'ISpeechPhraseReplacements', 'SRSActive',
    'tagSPPROPERTYINFO', 'DISPID_SVEWord', 'SPINTERFERENCE_NOSIGNAL',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPEAudioTimeOffset', 'SPEI_RESERVED2', 'SGSDisabled',
    'ISpRecoContext2', 'SPWT_PRONUNCIATION', 'ISpLexicon',
    'SPXMLRESULTOPTIONS', 'SPSERIALIZEDRESULT',
    'DISPID_SPERequiredConfidence',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SITooLoud',
    'DISPID_SRProfile', 'DISPID_SpeechPhraseInfo',
    'SpeechCategoryAppLexicons', 'eWORDTYPE_DELETED', 'SPGS_DISABLED',
    'DISPID_SPEEngineConfidence', 'DISPID_SPRs_NewEnum',
    'DISPID_SGRSRule', 'SpeechTokenKeyAttributes',
    'ISpeechXMLRecoResult', 'SPVPRIORITY', 'eLEXTYPE_APP',
    'DISPID_SGRsDynamic', 'DISPID_SRGetPropertyString', 'SVP_14',
    'SPEI_WORD_BOUNDARY', 'DISPID_SPCPhoneToId', 'SpeechVoiceEvents',
    'DISPID_SWFEChannels', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SVSCurrentStreamNumber', 'SpPhoneConverter',
    'SP_VISEME_19', 'ISpPhoneticAlphabetSelection',
    'Speech_StreamPos_RealTime', 'DISPID_SGRAddResource',
    'SPWORDLIST', 'ISpAudio', 'SAFT22kHz8BitMono', 'SPAS_STOP',
    'SPCT_COMMAND', 'DISPID_SCSBaseStream', 'SPXRO_Alternates_SML',
    'Speech_StreamPos_Asap', 'ISpeechRecoContext', 'SPSModifier',
    'DISPID_SLGetWords', 'DISPID_SRCESoundStart',
    'SAFT48kHz8BitStereo', 'SAFT12kHz8BitStereo',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRCreateRecoContext',
    'DISPID_SRRTStreamTime', 'DISPID_SVESentenceBoundary',
    'eLEXTYPE_RESERVED9', 'SAFTADPCM_11kHzMono',
    'SPEI_SR_RETAINEDAUDIO', 'SPEI_RESERVED1', 'SGRSTTEpsilon',
    'DISPID_SPPNumberOfElements', 'SPPS_Function',
    'SpeechPropertyAdaptationOn', 'SAFT12kHz8BitMono',
    'DISPID_SDKCreateKey', 'DISPID_SVSpeakStream',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechLexiconWord',
    'SPCT_SUB_COMMAND', 'SAFTText', 'DISPID_SDKDeleteValue',
    'SAFT24kHz16BitMono', 'ISpStream', 'SRATopLevel',
    'DISPID_SPIReplacements', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'eWORDTYPE_ADDED', 'DISPID_SPPName', 'STSF_FlagCreate',
    'SREAdaptation', 'SP_VISEME_12', 'SASStop',
    'DISPID_SOTMatchesAttributes', 'DISPID_SDKEnumValues',
    'SAFT11kHz16BitMono', 'DISPID_SRCCreateResultFromMemory',
    'SpeechCategoryRecognizers', 'SpeechUserTraining',
    'DISPID_SRRTimes', 'SpeechWordType',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_RESERVED4',
    'DISPID_SPEsItem', 'DISPID_SRRecognizer',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCRetainedAudio',
    'ISpStreamFormatConverter', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SpeechLexiconProns', 'SPDATAKEYLOCATION',
    'DISPID_SRCSetAdaptationData', 'DISPIDSPTSI_SelectionOffset',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRGCmdLoadFromMemory', 'SVEBookmark', 'SPWF_INPUT',
    'DISPID_SRCPause', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SWFESamplesPerSec', 'DISPID_SVPriority',
    'DISPID_SpeechLexiconWords', 'SP_VISEME_18', 'ISpeechVoiceStatus',
    'SECFEmulateResult', 'DISPID_SMSALineId', 'SPLOADOPTIONS',
    'SPSHT_Unknown', 'SPVPRI_NORMAL', 'DISPID_SPIElements',
    'SPEI_ADAPTATION', 'ISpObjectWithToken', 'SREInterference',
    'DISPID_SABIMinNotification', 'ISpeechDataKey', 'SVSFIsFilename',
    'DISPID_SBSWrite', 'SDTReplacement',
    'DISPID_SpeechPhoneConverter', 'SAFTADPCM_44kHzStereo',
    'SpeechRegistryUserRoot', 'SPDKL_CurrentUser', 'SVP_19',
    'DISPID_SRCEFalseRecognition', 'SWPUnknownWordUnpronounceable',
    'SAFT48kHz16BitMono', 'DISPID_SpeechLexiconWord', 'SPSHT_EMAIL',
    'SPFM_CREATE', 'ISpXMLRecoResult', 'eLEXTYPE_RESERVED6',
    'SPXRO_SML', 'SpeechAudioFormatGUIDWave',
    'SpeechEngineConfidence', 'SPSEMANTICFORMAT',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'eLEXTYPE_PRIVATE15', 'DISPID_SPRsItem',
    'DISPID_SOTGetDescription', 'eLEXTYPE_RESERVED7',
    'DISPID_SVAlertBoundary', 'DISPID_SLPLangId', 'SpeechRunState',
    'SECLowConfidence', 'DISPID_SPACommit',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SABIEventBias',
    'DISPID_SMSAMMHandle', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SVSLastStreamNumberQueued', 'SPSInterjection',
    'ISpeechObjectToken', 'SRSInactive', 'SDTAll',
    'ISpeechAudioStatus', 'DISPID_SVEViseme', 'SVESentenceBoundary',
    'SPBO_PAUSE', 'DISPID_SOTCId', 'eLEXTYPE_RESERVED8',
    'SpUnCompressedLexicon', 'SVP_0', 'SRCS_Enabled',
    'SREFalseRecognition', 'SpSharedRecognizer',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE4',
    'SPINTERFERENCE', 'SPEI_SENTENCE_BOUNDARY', 'SGRSTTDictation',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVGetAudioInputs', 'ISpeechPhraseAlternates',
    'SPEI_RECOGNITION', 'SAFTADPCM_44kHzMono', 'SDTAlternates',
    'SPBO_NONE', 'SGDSInactive', 'SREStreamEnd', '_RemotableHandle',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SpeechDataKey',
    'DISPID_SREmulateRecognition', 'DISPID_SOTCreateInstance',
    'DISPID_SpeechRecoContext', 'SRESoundStart', 'SVP_13', 'SVP_17',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPEI_RESERVED6',
    'DISPID_SpeechBaseStream', 'DISPID_SVGetVoices',
    'SPRECOGNIZERSTATUS', 'SPEVENTSOURCEINFO',
    'DISPID_SDKGetlongValue', 'DISPID_SVDisplayUI',
    'SPSTREAMFORMATTYPE', 'ISpObjectTokenCategory',
    'SpeechVisemeType', 'DISPID_SOTCGetDataKey', 'SECFIgnoreWidth',
    'SPINTERFERENCE_LATENCY_WARNING', 'STCLocalServer',
    'DISPID_SGRsCount', 'SVP_9', 'DISPID_SOTRemove', 'SVP_2',
    'DISPID_SASetState', 'DISPID_SVSkip', 'DISPID_SGRsItem',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SDTProperty',
    'SWPUnknownWordPronounceable', 'SSTTDictation',
    'DISPID_SPIAudioStreamPosition', 'SPEVENTENUM', 'SINoise',
    'SDTPronunciation', 'DISPID_SpeechAudioStatus',
    'SAFTCCITT_uLaw_22kHzStereo', 'SECHighConfidence',
    'DISPID_SRRGetXMLResult', 'SPRST_NUM_STATES', 'SPRECOSTATE',
    'SLODynamic', 'DISPID_SPAs_NewEnum', 'ISpeechFileStream',
    'DISPID_SASState', 'DISPID_SRGRecoContext', 'SDTDisplayText',
    'ISpNotifyTranslator', 'SP_VISEME_11',
    'DISPID_SLRemovePronunciation', 'SpeechGrammarTagDictation',
    'eLEXTYPE_PRIVATE13', 'SpeechAudioProperties',
    'DISPID_SRCEPropertyStringChange', 'ISpeechAudio',
    'DISPID_SPAsItem', 'SVPAlert', 'SPEI_MIN_SR',
    'DISPID_SpeechGrammarRules', 'SPINTERFERENCE_NOISE', 'SVP_16',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVVolume', 'SVSFParseSapi',
    'DISPID_SVGetProfiles', 'eLEXTYPE_USER',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SGRClear',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPRuleParent', 'DISPID_SRRPhraseInfo',
    'SAFT32kHz8BitMono', 'SDTAudio', 'ISpeechRecoResult',
    'SPDKL_CurrentConfig', 'SpVoice',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechPhraseInfo', 'DISPID_SVAudioOutput',
    'SpeechDataKeyLocation', 'DISPID_SRGCommit',
    'eLEXTYPE_LETTERTOSOUND', 'SpeechDictationTopicSpelling',
    'SRSEDone', 'ISpeechLexiconPronunciations', 'STSF_CommonAppData',
    'DISPID_SMSGetData', 'SPDKL_LocalMachine',
    'ISpeechAudioBufferInfo', 'ISpRecognizer3', 'SLTApp',
    'DISPID_SpeechVoice', 'SPADAPTATIONRELEVANCE', 'SPSUnknown',
    'DISPID_SRGCmdLoadFromResource', 'SpeechTokenValueCLSID',
    'DISPID_SDKOpenKey', 'DISPID_SASFreeBufferSpace',
    'SpeechGrammarTagWildcard', 'SVF_Stressed', 'SpNotifyTranslator',
    'DISPID_SLWsCount', 'SGRSTTRule', 'DISPID_SPPFirstElement',
    'SpeechInterference', 'DISPID_SBSFormat',
    'DISPID_SRSCurrentStreamNumber', 'SPRST_ACTIVE', 'DISPID_SRState',
    'SpPhoneticAlphabetConverter', 'SVPOver',
    'DISPID_SDKSetStringValue', 'SPEI_SR_AUDIO_LEVEL',
    'eLEXTYPE_PRIVATE9', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT22kHz16BitStereo', 'DISPID_SPERetainedSizeBytes',
    'eLEXTYPE_MORPHOLOGY', 'SpeechVisemeFeature',
    ...
    'SWPKnownWordPronounceable', 'SPEI_FALSE_RECOGNITION', 'ISpVoice',
    'SP_VISEME_1', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'ISpeechObjectTokens', 'SDKLDefaultLocation',
    'DISPID_SpeechRecoResult2', 'SPSHORTCUTPAIR', 'SVSFlagsAsync',
    'DISPID_SGRs_NewEnum', 'SVP_1', 'SPEI_RESERVED3',
    'DISPID_SGRSAddWordTransition', 'DISPID_SPPEngineConfidence',
    ...
    'SpeechLexiconType', 'DISPID_SPEDisplayText', 'SVP_10',
    'ISpeechTextSelectionInformation', 'DISPID_SRCEBookmark',
    'SGSExclusive', 'SAFTDefault', 'SAFT22kHz16BitMono',
    'DISPID_SPAStartElementInResult', 'SPRULE',
    'SPEI_RECO_STATE_CHANGE', 'SVSFParseSsml',
    'ISpeechPhraseProperty', 'SRSInactiveWithPurge', 'SVSFIsNotXML',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPRNumberOfElements',
    'SP_VISEME_2', 'SPCATEGORYTYPE', 'SPPHRASEPROPERTY',
    'SGPronounciation', 'IStream', 'DISPID_SVSpeak',
    'DISPID_SRRTTickCount', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SRRSpeakAudio', 'SVSFPersistXML', 'DISPID_SOTId',
    'SpeechAudioVolume', 'SAFT12kHz16BitMono',
    'DISPID_SVSyncronousSpeakTimeout', 'SpLexicon',
    'DISPID_SPILanguageId', 'ISpRecoGrammar', 'SDKLLocalMachine',
    'DISPID_SGRSTWeight', 'SPEI_MAX_SR', 'DISPID_SRGDictationUnload',
    'SRCS_Disabled', 'SAFT8kHz16BitStereo', 'SGDSActive',
    'DISPID_SPIStartTime', 'DISPID_SOTCSetId', 'SAFT16kHz16BitStereo',
    'SSTTWildcard', 'SDA_No_Trailing_Space', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechLexicon', 'ISpEventSource', 'SECFIgnoreKanaType',
    'SASClosed', 'SpeechStreamSeekPositionType', 'DISPID_SRGReset',
    'DISPID_SLWType', 'SP_VISEME_16', 'DISPID_SRIsShared',
    'DISPID_SAFGetWaveFormatEx', 'STCRemoteServer',
    'DISPID_SGRSTRule', 'SpeechCategoryAudioOut', 'SGDisplay',
    'eLEXTYPE_PRIVATE11', 'SPPHRASEREPLACEMENT', 'SPAO_RETAIN_AUDIO',
    'SP_VISEME_5', 'SAFT24kHz8BitMono', 'SPRS_ACTIVE',
    'SDA_Two_Trailing_Spaces', 'SDA_One_Trailing_Space',
    'DISPID_SPIAudioSizeTime', 'ISpeechPhraseProperties',
    'DISPID_SRSCurrentStreamPosition', 'SAFTGSM610_11kHzMono',
    'DISPID_SpeechVoiceEvent', 'ISpeechResourceLoader',
    'SPFM_CREATE_ALWAYS', 'SVP_3', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFT48kHz8BitMono', 'SPAS_RUN', 'SPPHRASE', 'SECFIgnoreCase',
    'SSFMOpenForRead', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SWFEBitsPerSample', 'DISPID_SGRSTText',
    'tagSPTEXTSELECTIONINFO', 'tagSTATSTG', 'SSSPTRelativeToStart',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPELexicalForm',
    'SREPrivate', 'SVSFVoiceMask', 'SpeechVoiceSpeakFlags',
    'SpMMAudioIn', 'DISPID_SPAPhraseInfo', 'SGDSActiveUserDelimited',
    'eLEXTYPE_PRIVATE1', 'SPEI_PROPERTY_NUM_CHANGE', 'SPWF_SRENGINE',
    'SPPROPERTYINFO', 'DISPID_SDKSetBinaryValue', 'SP_VISEME_7',
    'SP_VISEME_15', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPEAudioStreamOffset',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRCEEndStream',
    'SITooQuiet', 'DISPID_SRCERecognitionForOtherContext',
    'ISpeechWaveFormatEx', 'SPCONTEXTSTATE',
    'SpeechAudioFormatGUIDText', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRCVoice', 'DISPID_SPIProperties', 'SBOPause',
    'SRTStandard', 'SPPARTOFSPEECH', 'DISPID_SVIsUISupported',
    'SpeechTokenContext', 'SPSNotOverriden', 'DISPID_SPPParent',
    'DISPID_SOTCategory', 'SPAO_NONE', 'SPCS_ENABLED',
    'DISPID_SpeechPhraseReplacement', 'ISpResourceManager',
    'SpeechEngineProperties', 'DISPID_SMSSetData', 'ISpRecognizer',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPRulesCount',
    'SPWORDPRONOUNCEABLE', 'DISPID_SpeechRecoContextEvents',
    'SPFM_NUM_MODES', 'SVP_7', 'DISPID_SPIRetainedSizeBytes',
    'SREPropertyNumChange', 'SVF_Emphasis',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SGRInitialState',
    'DISPID_SRGDictationSetState', 'ISpeechRecognizer',
    'DISPID_SPIEngineId', 'DISPID_SABufferNotifySize',
    'DISPID_SVSLastBookmark', 'DISPID_SGRAddState', 'SVP_12',
    'SRADefaultToActive', 'DISPID_SLGetPronunciations',
    'DISPID_SRSClsidEngine', 'ISpeechGrammarRule',
    'DISPID_SRGSetWordSequenceData', 'SPEI_TTS_PRIVATE',
    'ISpPhraseAlt', 'ISpeechRecoResult2', 'SP_VISEME_20',
    'SpStreamFormatConverter', 'DISPID_SPIAudioSizeBytes',
    'SPDKL_DefaultLocation', 'SpeechMicTraining', 'SPPHRASERULE',
    'SPSERIALIZEDPHRASE', 'DISPID_SOTDisplayUI', 'DISPID_SFSClose',
    'SpeechStreamFileMode', 'SRSActiveAlways',
    'SPINTERFERENCE_TOOFAST', 'SPEI_END_INPUT_STREAM',
    'ISpRecoResult', 'ISpGrammarBuilder', 'DISPID_SLAddPronunciation',
    'DISPID_SRCEEnginePrivate', 'DISPID_SpeechAudioFormat',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechBaseStream',
    'SpeechDiscardType', 'SGDSActiveWithAutoPause',
    'DISPID_SOTCEnumerateTokens', 'SVP_18', 'SVP_6', 'SPAS_PAUSE',
    'SVEPrivate', 'ISpeechPhoneConverter', 'SPINTERFERENCE_NONE',
    'DISPID_SRRAudio', 'ISpeechMemoryStream', 'ISpPhrase',
    'SPAUDIOSTATE', 'DISPID_SGRId', 'DISPID_SAStatus',
    'STCInprocHandler', 'SPCT_SLEEP', 'SAFT11kHz8BitStereo',
    'ISpPhoneConverter', 'DISPID_SpeechObjectToken', 'SPAUDIOOPTIONS',
    'DISPID_SPIGetDisplayAttributes', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SPEDisplayAttributes', 'SRERequestUI',
    'DISPID_SAEventHandle', 'DISPID_SLWPronunciations',
    'SP_VISEME_14', 'SPSVerb', 'DISPID_SOTsItem', 'SVSFDefault',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SAFTCCITT_ALaw_8kHzMono', 'SPEI_VOICE_CHANGE',
    'SpeechGrammarRuleStateTransitionType', 'SP_VISEME_13',
    'SAFTGSM610_22kHzMono', 'DISPID_SLWLangId', 'eLEXTYPE_PRIVATE19',
    'SpCompressedLexicon', 'SPAR_Unknown', 'DISPID_SPEsCount',
    'ISpeechCustomStream', 'DISPID_SpeechFileStream',
    'SAFT11kHz8BitMono', 'DISPID_SFSOpen',
    'DISPID_SRGIsPronounceable', '_SPAUDIOSTATE', 'SPWORDTYPE',
    'WAVEFORMATEX', 'DISPID_SRDisplayUI',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPWT_LEXICAL', 'SpeechFormatType', 'DISPID_SRSetPropertyNumber',
    'IInternetSecurityMgrSite', 'DISPID_SRCEPhraseStart',
    'SREAudioLevel', 'SAFT48kHz16BitStereo', 'DISPID_SRRAlternates',
    'DISPID_SpeechPhraseRules', 'ISpPhoneticAlphabetConverter',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SAFType',
    'SpeechCategoryVoices', 'SP_VISEME_10', 'DISPID_SpeechMMSysAudio',
    'ISpeechGrammarRuleStateTransition', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPIGetText', 'eLEXTYPE_PRIVATE6', 'SGRSTTWord',
    'SAFT12kHz16BitStereo', 'SPRECOCONTEXTSTATUS', 'DISPID_SVVoice',
    'SREAllEvents', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SVSRunningState', 'SpMemoryStream',
    'DISPID_SRCERecognition', 'SAFTADPCM_8kHzStereo',
    'IInternetSecurityManager', 'SVP_15', 'DISPID_SRCRecognizer',
    'DISPIDSPRG', 'ISpShortcut', 'SAFTNonStandardFormat',
    'SPSMF_SAPI_PROPERTIES', 'SAFT16kHz16BitMono', 'SVP_11',
    'SpMMAudioEnum', 'DISPID_SGRSTPropertyId', 'DISPID_SPPChildren',
    'SAFT16kHz8BitMono', 'SAFTGSM610_8kHzMono', 'DISPID_SGRsCommit',
    'DISPID_SpeechPhraseAlternate', 'SRESoundEnd', 'ISpNotifySink',
    'SpeechTokenIdUserLexicon', 'SGSEnabled', 'SPBO_TIME_UNITS',
    'SpeechAudioState', 'STSF_LocalAppData', 'SAFTGSM610_44kHzMono',
    'DISPID_SGRsCommitAndSave', 'SECFDefault', 'DISPID_SVSVisemeId',
    'SPPS_Interjection', 'IEnumString', 'DISPID_SGRSTType',
    'SPEI_HYPOTHESIS', 'DISPID_SOTRemoveStorageFileName', 'SRAImport',
    'SpAudioFormat', 'DISPID_SVRate', 'SAFTCCITT_uLaw_8kHzMono',
    'SAFT32kHz8BitStereo', 'DISPID_SRRAudioFormat', 'DISPID_SPRText',
    'DISPID_SRRRecoContext', 'ISpeechVoice', 'DISPID_SVEBookmark',
    'eLEXTYPE_PRIVATE20', 'Speech_Default_Weight',
    'SpeechRetainedAudioOptions', 'DISPID_SLWsItem',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPEs_NewEnum',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SINoSignal',
    'ISpeechRecognizerStatus', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRAudioInputStream', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPAsCount', 'DISPID_SVSInputWordPosition',
    'SPEI_SR_PRIVATE', 'DISPID_SLGenerationId',
    'DISPID_SpeechRecognizer', 'SECNormalConfidence',
    'DISPID_SpeechPhraseProperties', 'DISPID_SOTSetId',
    'DISPID_SPRuleFirstElement', 'DISPID_SpeechAudio',
    'SECFNoSpecialChars', 'SVEAllEvents',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SOTGetStorageFileName',
    'ISpRecoContext', 'SPPHRASEELEMENT', 'SPEI_MIN_TTS',
    'DISPID_SRGId', 'SVEWordBoundary', 'SpeechRecoEvents',
    'SPPS_RESERVED2', 'SP_VISEME_17', 'SSFMOpenReadWrite',
    'SpInprocRecognizer', 'DISPID_SDKSetLongValue',
    'SpTextSelectionInformation', 'SpCustomStream', 'SPEI_REQUEST_UI',
    'SpeechRecognizerState', 'DISPID_SGRSTPropertyName',
    'SPGRAMMARWORDTYPE', 'DISPID_SpeechPhraseRule',
    'SpeechTokenKeyUI', 'ISpeechObjectTokenCategory',
    'SpNullPhoneConverter', 'SPAUDIOSTATUS', 'SVSFIsXML',
    'SRTSMLTimeout', 'SpeechRecoContextState', 'DISPID_SLWWord',
    'eLEXTYPE_PRIVATE8', 'SVP_5',
    'SpeechPropertyNormalConfidenceThreshold',
    '_ISpeechRecoContextEvents', 'SpeechCategoryPhoneConverters',
    'DISPID_SVEStreamEnd', 'DISPID_SpeechRecoResult',
    'SAFTExtendedAudioFormat', 'DISPID_SRCESoundEnd',
    'SpeechGrammarTagUnlimitedDictation', 'ISpRecoCategory',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRRTOffsetFromStart', 'SPPS_Noncontent', 'SRTAutopause',
    'SpeechSpecialTransitionType', 'ISpeechLexicon',
    'DISPID_SRCEInterference', 'DISPID_SPIGrammarId',
    'DISPID_SRCEStartStream', 'DISPID_SGRSTPropertyValue',
    'DISPID_SPRuleChildren', 'SVP_21', 'DISPID_SGRAttributes',
    'DISPID_SRSAudioStatus', 'DISPID_SLPs_NewEnum',
    'Speech_Max_Word_Length', 'SAFT24kHz8BitStereo',
    'DISPID_SGRSTsCount', 'SPEI_VISEME', 'DISPID_SLPsItem',
    'DISPID_SWFEBlockAlign', 'Speech_Max_Pron_Length', 'SPAR_Low',
    'SPEI_SOUND_START', 'SREPropertyStringChange',
    'ISpeechGrammarRules', 'DISPID_SRIsUISupported',
    'SPTEXTSELECTIONINFO', 'DISPID_SPISaveToMemory',
    'DISPID_SRStatus', 'DISPID_SpeechPhraseElement',
    'eLEXTYPE_PRIVATE2', 'DISPID_SRGState', 'eLEXTYPE_PRIVATE14',
    'SPVOICESTATUS', 'SPBO_AHEAD', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRCEventInterests', 'SAFT44kHz16BitStereo',
    'DISPID_SPPsItem', 'DISPID_SPRuleName', 'SPAR_High',
    'DISPID_SVPause', 'ISpStreamFormat', 'SPEI_PHONEME',
    'SPCT_SUB_DICTATION', 'SPEI_START_SR_STREAM', 'ISequentialStream',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPPConfidence',
    'SREBookmark', 'SRTEmulated', 'SSTTTextBuffer',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSHT_OTHER',
    'SpeechPropertyResourceUsage', 'SpeechBookmarkOptions',
    'DISPID_SBSSeek', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SRGetFormat', 'SAFTADPCM_22kHzStereo',
    'DISPID_SVSInputSentenceLength', 'SAFTCCITT_ALaw_44kHzMono',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'STCInprocServer',
    'SPLEXICONTYPE', 'DISPID_SPCLangId',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SASNonBlockingIO', 'STCAll', 'DISPID_SRGSetTextSelection',
    'DISPID_SVEVoiceChange', 'DISPID_SPEAudioSizeBytes',
    'SPRS_INACTIVE', 'DISPID_SRSNumberOfActiveRules',
    'ISpeechRecoGrammar', 'DISPID_SDKGetStringValue', 'SPAS_CLOSED',
    'SDA_Consume_Leading_Spaces', 'SpeechRuleState', 'SVP_4',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRGDictationLoad',
    'DISPID_SRSSupportedLanguages', 'SPPS_NotOverriden', 'SITooSlow',
    'DISPID_SpeechObjectTokens', 'SLTUser', 'SAFT11kHz16BitStereo',
    'LONG_PTR', 'SPWT_DISPLAY', 'DISPID_SPIRule',
    'ISpeechLexiconWords', 'DISPID_SVSLastResult', 'SPPS_RESERVED3',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SGRSTsItem',
    'SVEStartInputStream', 'DISPID_SVAudioOutputStream', 'SDTRule',
    'DISPID_SOTs_NewEnum', 'SP_VISEME_6', 'SpeechRecognitionType',
    'SAFT24kHz16BitStereo', 'DISPID_SPPs_NewEnum', 'SPSMF_UPS',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPSLMA', 'SPRST_ACTIVE_ALWAYS',
    'ISpEventSink', 'SPAR_Medium', 'DISPID_SPPsCount',
    'ISpRecognizer2', 'SASPause', 'SGLexical',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPRDisplayAttributes',
    'eLEXTYPE_PRIVATE18', 'SPPS_LMA', 'SpInProcRecoContext',
    'DISPID_SOTGetAttribute', 'SpResourceManager', 'DISPID_SGRsAdd',
    'SPBINARYGRAMMAR', 'DISPID_SGRSTNextState', 'SAFT8kHz8BitMono',
    'SREHypothesis', 'DISPID_SVSLastBookmarkId', 'SPEVENT',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechAddRemoveWord',
    'DISPID_SPEActualConfidence', 'DISPID_SLPSymbolic', 'SRTReSent',
    'ISpeechPhraseAlternate', 'SAFT16kHz8BitStereo',
    'SpeechTokenShellFolder', 'SPLO_STATIC', 'DISPID_SOTDataKey',
    'SPEI_MAX_TTS', 'DISPID_SpeechPhraseReplacements', 'ISpDataKey',
    'SPWORDPRONUNCIATIONLIST', 'SRERecognition', 'DISPID_SRRTLength',
    'DISPID_SABufferInfo', 'SPEI_SR_BOOKMARK', 'SPCT_DICTATION',
    'DISPID_SOTIsUISupported', 'SpPhraseInfoBuilder',
    'DISPID_SRGetPropertyNumber', 'SRTExtendableParse',
    'SPLO_DYNAMIC', 'SpeechPartOfSpeech', 'DISPID_SAVolume',
    'SPPS_Modifier', 'DISPID_SLPType', 'ISpeechPhraseElement',
    'SAFTCCITT_uLaw_22kHzMono', 'SSFMCreateForWrite',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SpeechVoiceStatus',
    'SPPS_Noun', 'SPSHT_NotOverriden', 'SAFT8kHz16BitMono',
    'DISPID_SRRSaveToMemory', 'DISPID_SRCCmdMaxAlternates',
    'SSSPTRelativeToEnd', 'SVEAudioLevel',
    ...
    'SpeechCategoryRecoProfiles', 'UINT_PTR',
    'ISpeechRecoResultTimes', 'DISPID_SDKGetBinaryValue', 'SVP_8',
    'SPCS_DISABLED', 'SPWORDPRONUNCIATION', 'ISpRecoGrammar2',
    'DISPID_SVSInputSentencePosition', 'SpeechRecoProfileProperties',
    'SPINTERFERENCE_TOOLOUD', 'SAFTADPCM_8kHzMono', 'DISPIDSPTSI',
    'SRADynamic', 'SAFTCCITT_ALaw_22kHzMono', 'SPEI_TTS_BOOKMARK',
    'SPEI_SOUND_END', 'SREStreamStart', 'ISpeechMMSysAudio',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSTransitions',
    'ISpeechRecoResultDispatch', 'SPRULESTATE', 'SFTInput',
    'SP_VISEME_4', 'SAFT32kHz16BitStereo', 'SAFTADPCM_11kHzStereo',
    'SPRECORESULTTIMES', 'DISPID_SLPPhoneIds', 'SPGS_EXCLUSIVE',
    'SPSFunction', 'SPWAVEFORMATTYPE', 'DISPID_SLPsCount',
    'DISPID_SRCAudioInInterferenceStatus', 'SVEPhoneme',
    'SAFTCCITT_ALaw_11kHzMono', 'SpSharedRecoContext',
    'SpeechGrammarState', 'SpStream',
    'DISPID_SGRSAddSpecialTransition', 'ISpeechPhraseReplacement',
    'SPWORD', 'SVSFNLPMask', 'ISpSerializeState',
    'DISPID_SpeechCustomStream', 'SPSHORTCUTTYPE',
    'DISPID_SDKEnumKeys', 'DISPID_SABIBufferSize',
    'SGLexicalNoSpecialChars', 'SpeechCategoryAudioIn', 'SASRun',
    'SRAExport', 'DISPID_SPPId', 'DISPID_SRCBookmark',
    'SPGRAMMARSTATE', 'DISPID_SRGCmdLoadFromFile', 'SPVPRI_ALERT',
    'SPVPRI_OVER', 'ISpeechGrammarRuleState', 'SAFTADPCM_22kHzMono',
    'DISPID_SVStatus', 'SPEI_INTERFERENCE', 'SPAUDIOBUFFERINFO',
    'SRSEIsSpeaking', 'eLEXTYPE_PRIVATE7',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVSInputWordLength',
    'SINone', 'SPEI_UNDEFINED', 'STSF_AppData', '_ISpeechVoiceEvents',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRAInterpreter',
    'SPFILEMODE', 'DISPID_SDKDeleteKey', 'SPEI_RESERVED5',
    'SP_VISEME_21', 'SPPS_RESERVED4', 'DISPID_SRGCmdSetRuleState',
    'eLEXTYPE_PRIVATE3', 'SpeechAudioFormatType', 'SLOStatic',
    'SpeechRuleAttributes', 'DISPID_SpeechMemoryStream',
    'DISPID_SVResume', 'DISPID_SBSRead', 'SVF_None', 'SPPS_Verb',
    'SAFT8kHz8BitStereo', 'DISPID_SpeechRecognizerStatus',
    'ISpProperties', 'SVPNormal', 'SITooFast', 'SVEEndInputStream',
    'DISPID_SPRulesItem', 'ISpeechAudioFormat', 'SP_VISEME_9',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechPhraseRules',
    'DISPID_SRCResume', 'SpFileStream', 'DISPID_SLWs_NewEnum',
    'DISPID_SRRDiscardResultInfo', 'SPFM_OPEN_READWRITE',
    'DISPID_SPCIdToPhone', 'SPRST_INACTIVE', 'SVSFParseAutodetect',
    'SVEViseme', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechPhraseElements', 'SPBOOKMARKOPTIONS',
    'IEnumSpObjectTokens', 'ISpMMSysAudio', 'SREStateChange',
    'DISPID_SPARecoResult', 'SRAONone', 'SpeechLoadOption', 'SRARoot',
    'DISPID_SWFEExtraData', 'SP_VISEME_8', 'ISpeechPhraseRule',
    'DISPID_SRAudioInput', 'DISPID_SRCRequestedUIType',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SMSADeviceId',
    'DISPID_SRCERequestUI', 'SP_VISEME_3', 'SpWaveFormatEx',
    'eLEXTYPE_PRIVATE16', 'SPPS_RESERVED1', 'DISPID_SGRSTs_NewEnum',
    'SFTSREngine', 'DISPID_SVEStreamStart', 'ISpeechPhraseElements',
    'DISPID_SPRsCount', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCCreateGrammar', 'DISPID_SPRFirstElement',
    'ISpNotifySource', 'SVSFUnusedFlags', 'SPGS_ENABLED',
    'DISPID_SRGCmdSetRuleIdState', 'SVSFNLPSpeakPunc',
    'SGRSTTTextBuffer', 'SVEVoiceChange', 'DISPID_SAFGuid',
    'SpeechDisplayAttributes', 'SAFT22kHz8BitStereo',
    'DISPID_SOTsCount', 'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPPValue',
    'SPFM_OPEN_READONLY', 'SpeechAllElements',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRSetPropertyString',
    'DISPID_SRCEHypothesis', 'SDTLexicalForm', 'SAFT44kHz8BitMono',
    'SpMMAudioOut', 'DISPID_SRCEAudioLevel', 'DISPID_SVEPhoneme',
    'SPEI_PHRASE_START'
]

_check_version('1.1.14', 1610694891.594001)
