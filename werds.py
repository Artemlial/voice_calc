# TRIGGERS = {'повадырь','помошник','кукиш'}

phatwerds = 'в на скобка'.split()
...
scenarios = {
            'ноль': 0, 'один': 1, 'два': 2, 'три': 3, 'четыре': 4, 'пять': 5, 'шесть': 6, 'семь': 7, 'восемь': 8, 'девять': 9,
             ...
             'шестьдесят': 60, 'семьдесят': 70, 'восемьдесят': 80, 'девяносто': 90, 'сто': 100, 'плюс': '+', 'минус минут': '-', 'умножить': '*', 
             'открывается': '(', 'закрывается': ')', 'степени': '**'
            }
